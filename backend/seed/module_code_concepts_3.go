...
func moduleCodeConcepts3() models.Module {
	return models.Module{
		...
		Content: []models.ContentBlock{
			...
			codeBlock("csharp", `Console.WriteLine("Hello!");
...
Iteration: 4`),
			...
			codeBlock("csharp", `string[] fruits = { "apple", "banana", "cherry", "date" };
...
while (count < 5) {
    ...
    count++;
			...
			codeBlock("csharp", `string[] students = { "Bob", "Alice", "Charlie", "Diana" };
bool found = false;
